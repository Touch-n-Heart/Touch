...
type Config struct {
	// flags
	Log LogConfig `yaml:"log_config" json:"log_config" toml:"log_config"`

	// server flags
	Server ServerConfig `yaml:"server_config" json:"server_config" toml:"server_config"`

	// db flags
	DB    DBConfig    `yaml:"db_config" json:"db_config" toml:"db_config"`
	Redis RedisConfig `yaml:"redis_config" json:"redis_config" toml:"redis_config"`
}
...
type RedisConfig struct {
	...
	RedisPasswd string `yaml:"redis_password" json:"redis_password" toml:"redis_password"`
	RedisDB     string `yaml:"redis_db" json:"redis_db" toml:"redis_db"`
}
